...
<section style="background-color:#603779; color:#FFF; height:335px;">
		<h1 id="sectitle" class="w1000" style="font-size:1.9em; font-weight:500; padding:15px 0 25px 0;">MYSTARTOUR SNS</h1>
		<iframe src='<?php echo G5_URL.'/snsimg/insta.php'?>?width=100%&inline=25&view=25&toolbar=false' data-inwidget scrolling='no' frameborder='no'
			style='border:none;width:105%; height:254px; margin:-15px 0px 15px -10px; overflow:hidden;'></iframe>
</section>
