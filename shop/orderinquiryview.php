...
$sql = " select * from {$g5['g5_shop_order_table']} a INNER JOIN {$g5['g5_shop_cart_table']} b ON a.od_id = b.od_id  where a.od_id = '$od_id' ";
...
<!-- 주문상세내역 시작 { -->
<div id="sod_fin" class="w1000">

    <div id="sod_fin_no" style="margin-top:50px !important;">주문번호 <strong><?php echo $od_id; ?></strong></div>
    ...
    <div class="sod_left" style="width:100% !important;">
        <h2>결제/배송 정보</h2>
        <?php
        ...
        <section id="sod_fin_pay">
            ...
            <div class="tbl_head01 tbl_wrap">
                ...
                <tr>
                    <th scope="row">상품일자</th>
                    <td><?= date('Y.m.d',strtotime($od['select_date'])) ; ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if($od['od_settle_case'] == '휴대폰')
                        {
                            ...
                            } else if($od['od_pg'] == 'eximbay') { // wetoz : eximbay
                                $hp_receipt_script = 'alert("휴대폰은 영수증이 발행되지 않습니다.");';
                            } else {
                        ...
                        if($od['od_settle_case'] == '신용카드' || is_inicis_order_pay($od['od_settle_case']) )
                        {
                            if($od['od_pg'] == 'lg') {
                                ...
                                $g_conf_receipt_url = str_replace("{transactid}", $od['od_tno'], $g_conf_receipt_url);
                                $g_conf_receipt_url = str_replace("{ref}", $od['od_id'], $g_conf_receipt_url);
                                $card_receipt_script = 'window.open(\''.$g_conf_receipt_url.'\', \'winreceipt\', \'width=800,height=815,scrollbars=yes,resizable=yes\');';
                            } else {
        ...
        <section id="sod_fin_orderer">
            ...
            <div class="tbl_head01 tbl_wrap">
                ...
                <tr>
                    ...
                    <td><?php echo get_text($od['od_addr1']); ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><?php echo get_text($od['r_addr']); ?></td>
                </tr>
                <tr>
        ...
        <section id="sod_fin_receiver">
            ...
            <div class="tbl_head01 tbl_wrap">
                ...
                <tr>
                    <th scope="row">Name</th>
                    <td><?php echo get_text($od['od_b_addr2']).' '.get_text($od['od_b_addr3']); ?></td>
                </tr>
                <tr>
                    <th scope="row">Gender</th>
                    <td><?php echo get_text($od['od_addr_jibeon']); ?></td>
                </tr>
                <tr>
                    <th scope="row">Country</th>
                    <td><?php echo get_text($od['od_b_addr1']); ?></td>
                </tr>
                <tr>
                    <th scope="row">Phone</th>
                ...
                <tr>
                    <th scope="row">Address</th>
                    <td><?php echo get_text($od['r_b_addr']); ?></td>
                </tr>
                <tr>
                    <th scope="row">E-mail</th>
                    <td><?php echo get_text($od['od_b_addr_jibeon']); ?></td>
                </tr>
                <tr>
                    <th scope="row">Memo</th>
                    <td><?php echo get_text($od['od_memo']); ?></td>
                </tr>
                <?php
                // 희망배송일을 사용한다면
    ...
    <div class="sod_right" style="box-shadow:none;">
        <ul id="sod_bsk_tot">
