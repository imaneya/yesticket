        ...
        <section class="sod_left fl m1 mf0">
            ...
            <section id="sod_frm_orderer">
                <div class="buyInfo" style="background-color:#FFF; padding:20px; margin-bottom:50px;">
                    ...
                    <div id="sit_inf_explan" style="padding:15px;">
                        <ul>
                          ...
                          <li>
                            ...
                            <li><textarea style="width:100%; float:left; height:150px" type="text" class="frm_input full_input name" name="od_memo" id="od_memo"></textarea></li>
                        </ul>
                    </div>
                    ...
                    <div id="sit_select_pay" style="padding:15px;">
                        <ul>
                            <li>
                              <?php
                              // wetoz : eximbay
                              ...
                              ?>
                                  ...
                                  if (is_array($de_eximbay_pay)) {
                                      ...
                                      foreach ($de_eximbay_pay as $k) {
                                          ...
                                          echo '<input type="radio" id="od_settle_eximbay' . $z . '" name="od_settle_case" value="' . $k . '" class="od_settle_eximbay" data-eximbay="1"' . $check . '>
                                                <label for="od_settle_eximbay' . $z . '" class="lb_icon ' . $pay_class . '" id="how_pay" style="margin-right:5%; padding-left:0.5%;">' . $pay_name . '</label>' . PHP_EOL;
                                          $z++;
                                      }
                                      $checked = '';
                                  }
                                ...
                                if ($default['de_bank_use']) {
                                  $multi_settle++;
                                  echo '<input type="radio" id="od_settle_bank" name="od_settle_case" value="무통장" '.$checked.'>
                                        <label for="od_settle_bank" class="lb_icon bank_icon" id="how_pay" style="padding-left:0;">무통장입금</label>'.PHP_EOL; $checked = '';
                                }
                                if ($default['de_bank_use']) {
                                    // 은행계좌를 배열로 만든후
                                    ...
                                    echo '</li>
                                          <div id="settle_bank" style="display:none; margin-top:15px;">';
