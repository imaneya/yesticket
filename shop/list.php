...
include_once(G5_SHOP_PATH.'/category.php');
define('G5_SHOP_CSS_URL', str_replace(G5_PATH, G5_URL, $skin_dir));

if ($is_admin)
   // echo '<div class="sct_admin w1000"><a href="'.G5_ADMIN_URL.'/shop_admin/categoryform.php?w=u&amp;ca_id='.$ca_id.'" class="btn_admin mt30">분류 관리</a></div>';
?>
...
<!-- 상품 목록 시작 { -->
<div id="sct" class="w3000 back_gray">
  <div id="sct" class="w1000">
	...
	// else{//하위분류이면 상위분류를 내보낸다
  //
	//   $top_ca_id=strlen($ca_id, 0 , strlen($ca_id)-2);
	//   $old_ca_id=$ca_id;
	//   $ca_id=$top_ca_id;
	//   include $cate_skin;
	//   $ca_id=$old_ca_id;
