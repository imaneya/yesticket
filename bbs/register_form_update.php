...
$mb_1           = isset($_POST['mb_1'])             ? trim($_POST['mb_1'])           : ""; // 국가
$mb_2           = isset($_POST['mb_2'])             ? trim($_POST['mb_2'])           : ""; // 년(생일)
$mb_3           = isset($_POST['mb_3'])             ? trim($_POST['mb_3'])           : ""; // 월(생일)
$mb_4           = isset($_POST['mb_4'])             ? trim($_POST['mb_4'])           : ""; // 일(생일)
$mb_5           = isset($_POST['mb_5'])             ? trim($_POST['mb_5'])           : ""; // 성별
$mb_6           = isset($_POST['mb_6'])             ? trim($_POST['mb_6'])           : ""; // 관심사
...
if ($w == '') {
    ...
    if ($old_email != $mb_email && $config['cf_use_email_certify']) {
        ...
        <title>회원정보수정</title>
        <body>
        <form name="fregisterupdate" method="post" action="'.G5_HTTP_BBS_URL.'/member_confirm.php?page=0">
