...
<article id="bo_v" class="w1000">
    ...
    <section id="bo_v_info">
        <span>Author :</span> <strong> <?php echo $view['name'] ?></strong>
		<span>Date :</span> <strong> <?php echo date("Y-m-d", strtotime($view['wr_datetime'])) ?></strong>
        <span>Hits :</span> <strong> <?php echo number_format($view['wr_hit']) ?></strong>
    </section>
    ...
    <div id="bo_v_top">
        ...
        <ul style="text-align:right; margin:10px 0px;">
            <?php if ($update_href&&$is_admin) { ?><a href="<?php echo $update_href ?>" class="btn_b01 btn"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modify</a><?php } ?>
            <?php if ($delete_href&&$is_admin) { ?><a href="<?php echo $delete_href ?>" class="btn_b01 btn" onclick="del(this.href); return false;"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a><?php } ?>
        </ul>
    ...
    <!-- } 게시물 상단 버튼 끝 -->
			...
			<ul class="tc" style="height:90px; border-top:2px solid #CCC;">
					<?php if ($prev_href) { ?><li class="btn_prv" style="float:left; margin-top:35px; font-size:1.1em; font-weight:700; color:#939393"><a href="<?php echo $prev_href ?>">< Back</a></li><?php } ?>
			    <li style="margin:30px 70px 0px 70px;"><a href="<?php echo $list_href ?>" class="purple_btn" style="padding:5px 40px 8px; font-size:1.3em; font-weight:800;">List</a></li>
					<?php if ($next_href) { ?><li class="btn_next" style="float:right; margin-top:-24px; font-size:1.1em; font-weight:700; color:#939393"><a href="<?php echo $next_href ?>">Next ></a></li><?php } ?>
      </ul>
