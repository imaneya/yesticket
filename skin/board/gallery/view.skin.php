...
<article id="bo_v" class="w1000">
    ...
    <div id="bo_v_top">
        ...
        <ul style="text-align:right; margin:10px 0px;">
            <?php if ($update_href) { ?><a href="<?php echo $update_href ?>" class="btn_b01 btn"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Modify</a><?php } ?>
            <?php if ($delete_href) { ?><a href="<?php echo $delete_href ?>" class="btn_b01 btn" onclick="del(this.href); return false;"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a><?php } ?>
        </ul>
