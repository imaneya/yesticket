...
$img_url = G5_SKIN_URL."/social/img/";
...
<div id="sns_login" class="login-sns sns-wrap-32 sns-wrap-over">
    <div class="sns-wrap">
		    <a href="<?php echo $self_url;?>?provider=wechat&amp;url=<?php echo $urlencode;?>" style="padding:0px; height:50px;" class="sns-icon social_link sns-wechat" title="wechat">
            <img src="<?php echo $img_url;?>wechat.png" class="ico"></img>
            <span class="txt">Sign in with Wechat</span>
        </a>
        ...
        <a href="<?php echo $self_url;?>?provider=facebook&amp;url=<?php echo $urlencode;?>" style="padding:0px;" class="sns-icon social_link sns-facebook" title="페이스북">
            <img src="<?php echo $img_url;?>fb.png" class="ico"></img>
        ...
        <a href="<?php echo $self_url;?>?provider=twitter&amp;url=<?php echo $urlencode;?>" style="padding:0px;" class="sns-icon social_link sns-twitter" title="트위터">
            <img src="<?php echo $img_url;?>tw.png" class="ico"></img>
            <span class="txt">Sign in with Twitter</span>
        </a>
        <?php }     //end if ?>
