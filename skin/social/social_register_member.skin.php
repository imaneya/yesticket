...
<!-- 회원정보 입력/수정 시작 { -->
<div class="mbskin w500" id="register_member">

    <script src="<?php echo G5_JS_URL ?>/jquery.register_form.js"></script>

    <!-- 새로가입 시작 -->
    <form id="fregisterform" class="mt50 mb50" name="fregisterform" action="<?php echo $register_action_url; ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="sns_tbl tbl_wrap">
        ...
        <tbody>
        <tr>
            <th scope="row" style="min-width:80px;"><label for="reg_mb_email">E-mail<strong class="sound_only">필수</strong></label></th>
            <td style="width:85%; margin-left:-80px;">
                <input type="text" style="width:100%;" name="mb_email" value="<?php echo isset($user_email)?$user_email:''; ?>" id="reg_mb_email" required class="frm_input email required" size="70" maxlength="100" placeholder="이메일을 입력해주세요." >
    ...
    <div class="btn_confirm">
        <input type="submit" value="Confirm" id="btn_submit" class="btn_submit" style="margin-bottom:5px;" accesskey="s">
        <a href="<?php echo G5_URL ?>" class="btn_cancel btn_submit" style="background-color:#FFF; color:#603779; padding:11px 35px; line-height:40px;">Cancel</a>
    </div>
    </form>
    <!-- 새로가입 끝 -->
