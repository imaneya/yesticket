...
<?php } ?>
<!-- 검색 시작 { -->
<div id="ssch" class="mb50 mt50">
    <!-- 상세검색 항목 시작 { -->
    <div id="ssch_frm" class="none">
    ...
    <!-- 검색된 분류 시작 { -->
    <div id="ssch_cate" class="sct_ct none">
        <ul>
        <?php
    ...
    <div class="w1000">
        ...
        if (file_exists($list_file)) {
            ...
            $list = new item_list($list_file, $default['de_search_list_mod'], $default['de_search_list_row'], 279, 394);
