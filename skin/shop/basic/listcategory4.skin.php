...
<!-- 상품분류 2 시작 { -->
<aside id="sct_ct_2" class="sct_ct len<?=$len2?> mb30">
    <ul>
        <?php echo $str; ?>
    </ul>
</aside>
...
<style>
	...
	.len2 #submenu span, .len4 li {justify-content: space-around; flex: 1; text-align: center; background-color:#FFF; border-right:#CCC 1px solid;}
	.len2 #submenu span:last-child, .len4 li:last-child {border-right:none;}
	.len2 li, .len4 ul {display: flex;}
	#submenu span a {padding:15px; display: inline-block;}
	.ct_here{background-color:#603779 !important; color:#FFF;}
