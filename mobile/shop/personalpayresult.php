                ...
                <tr>
                    ...
                    <td>
                        ...
                        if($pp['pp_settle_case'] == '휴대폰')
                        {
                            ...
                            } else if ($pp['pp_pg'] == 'eximbay') { // wetoz : eximbay
                        ...
                        if($pp['pp_settle_case'] == '신용카드')
                        {
                            if($pp['pp_pg'] == 'lg') {
                                ...
                                $g_conf_receipt_url = str_replace("{transactid}", $pp['pp_tno'], $g_conf_receipt_url);
                                $g_conf_receipt_url = str_replace("{ref}", $pp['pp_id'], $g_conf_receipt_url);
