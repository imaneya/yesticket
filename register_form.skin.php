...
<style>
	input, select {padding:10px 15px; margin-bottom:10px; color:#111;}
	label.button {border:1px solid #b5a2c1; padding:10px; color:#603779}
	.form_01 li { margin: 10px 1px; }
	#register_form { border: 1px solid #bbb; }
	#fregisterform label {padding-left: 8px; font-size: 14px; font-weight:600;display: inline-block; margin-bottom : 5px; color : #515151;}
	...
	#fregisterform input[type=radio]:radio+label{background-image:none; height:40px; background-color:#fff;  margin-bottom:10px; color:#c0c0c0;;}
	#fregisterform input[type=checkbox]{display:none; margin:10px;}
	#fregisterform input[type=checkbox]+label{display:inline-block; padding-left:0px !important; margin:-2px; height:40px; margin-left:0.1%; padding-top:10px; text-align:center; background-color:#816095; color:#fff; font-weight:700; border:1px solid #603779;}
    ...
    <div>
        ...
        <ul>
            <li>
                ...
                <span id="msg_mb_id"></span>
								...
								style="background-color:#816095; margin-top:-10px; border-color:#816095; font-weight:500; font-size:1.0em; width:80px; height:40px;">
            </li>
            <li>
			...
			<li class="fl p2" style="width : 49.5%;">
					<label for="reg_mb_name">First name</strong></label>
					<input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input w100 <?php echo $required ?> <?php echo $readonly ?>" size="10" placeholder="First Name">
					<?php
			...
			<li class="fl p2" style="width : 49.5%;">
					<label for="reg_mb_nick">Last name</label>

							<input type="hidden" name="mb_nick_default" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>">
							<input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick'])?get_text($member['mb_nick']):''; ?>" id="reg_mb_nick" required class="frm_input w100 required nospace" size="10" maxlength="20" placeholder="Last Name">
	 ...
	 <li style="margin-bottom:20px;">
                ...
                <input type="hidden" name="mb_5" id="mb_5">
		 		<label class="fl p2 tc button" for="Male" style="width : 49.8%; margin: 0.1%;">
...
-->
	 		<li>
				<div class="btn_confirm" style="margin:50px auto 0;">
					<a href="<?php echo G5_URL ?>" class="btn_cancel purple purple_btn2 fl p2" style="margin:0;">CANCEL</a>
					<input type="submit" value="<?php echo $w==''?'CONFIRM':'CONFIRM'; ?>" id="btn_submit" class="btn_submit purple_btn p2" style="margin:0;" accesskey="s">
				</div>
			</li>
        </ul>
    </div>
    ...
    $(function() {
        ...
        $('input[name=gender]').click(function(){
            ...
            $('label[for=Male]').css("color","#515151");
            $('label[for=Male]').css("background-color","#FFF");
            $('label[for=Female]').css("color","#515151");
