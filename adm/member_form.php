...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tbody>
    <tr>
        <th scope="row"><label for="mb_id">ID<?php echo $sound_only ?></label></th>
        <td>
        ...
        <th scope="row"><label for="mb_password">Password<?php echo $sound_only ?></label></th>
    ...
    <tr>
        <th scope="row"><label for="mb_name">First Name<strong class="sound_only">필수</strong></label></th>
        ...
        <th scope="row"><label for="mb_nick">Last Name<strong class="sound_only">필수</strong></label></th>
    ...
    <tr>
        <th scope="row"><label for="mb_1">Nationality</label></th>
        <td><input type="text" name="mb_1" value="<?php echo $mb['mb_1'] ?>" id="mb_1" class="frm_input" size="15" maxlength="255"></td>
        <th scope="row"><label for="mb_2">Year</label></th>
        <td><input type="text" name="mb_2" value="<?php echo $mb['mb_2'] ?>" id="mb_2" class="frm_input" size="15" maxlength="255"></td>
    </tr>
    <tr>
        <th scope="row"><label for="mb_3">Month</label></th>
        <td><input type="text" name="mb_3" value="<?php echo $mb['mb_3'] ?>" id="mb_3" class="frm_input" size="15" maxlength="255"></td>
        <th scope="row"><label for="mb_4">Day</label></th>
        <td><input type="text" name="mb_4" value="<?php echo $mb['mb_4'] ?>" id="mb_4" class="frm_input" size="15" maxlength="255"></td>
    </tr>
    <tr>
        <th scope="row"><label for="mb_5">Gender</label></th>
        <td><input type="text" name="mb_5" value="<?php echo $mb['mb_5'] ?>" id="mb_5" class="frm_input" size="15" maxlength="255"></td>
        <th scope="row"><label for="mb_6">Category</label></th>
        <td><input type="text" name="mb_6" value="<?php echo $mb['mb_6'] ?>" id="mb_6" class="frm_input" size="15" maxlength="255"></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="3" class="td_addr_line">
            ...
            <label for="mb_addr3" class="none">참고항목</label>
            <input class="none" type="hidden" name="mb_addr_jibeon" value="<?php echo $mb['mb_addr_jibeon']; ?>"><br>
        </td>
    </tr>
    <tr class="none">
