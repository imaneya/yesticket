...
<select name="it_cns" id="it_cns" style="width:100px;">
  <option value="2" <?php echo get_selected($it_cns, '2'); ?>>전체&nbsp;&nbsp;</option>
  <option value="0" <?php echo get_selected($it_cns, '0'); ?>>영문&nbsp;&nbsp;</option>
  <option value="1" <?php echo get_selected($it_cns, '1'); ?>>중문&nbsp;&nbsp;</option>
</select>
</form>
