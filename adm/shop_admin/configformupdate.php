...
// wetoz : eximbay
$de_eximbay_pay = serialize($_POST['de_eximbay_pay']);
$sql = " update {$g5['g5_shop_default_table']}
            set de_eximbay_use          = '{$_POST['de_eximbay_use']}',
                de_eximbay_mid          = '{$_POST['de_eximbay_mid']}',
                de_eximbay_key          = '{$_POST['de_eximbay_key']}',
                de_eximbay_cur          = '{$_POST['de_eximbay_cur']}',
                de_eximbay_lan          = '{$_POST['de_eximbay_lan']}',
                de_eximbay_pay          = '{$de_eximbay_pay}'
                ";
sql_query($sql, true);
