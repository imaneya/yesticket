...
// 주문서 정보
//------------------------------------------------------------------------------
$sql = " select a.*,b.select_date from {$g5['g5_shop_order_table']} a INNER JOIN {$g5['g5_shop_cart_table']} b ON a.od_id = b.od_id  where a.od_id = '$od_id' ";
$od = sql_fetch($sql);
if (!$od['od_id']) {
    ...
    <div class="compare_wrap">
        ...
        <section id="anc_sodr_chk" class="compare_left">
            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    <th scope="row" class="sodr_sppay">주문일자</th>
                    <td>
                        ...
                        if ($od['od_settle_case'] != '무통장') {
                            switch($od['od_pg']) {
                                ...
                                case 'KAKAOPAY':
                                    ...
                                    $pg_test = 'KAKAOPAY';
                                    break;
                                case 'eximbay': // wetoz : eximbay
                                    $pg_url  = 'https://merchant.eximbay.com/backoffice/common/login.do';
                                    $pg_test = '엑심베이';
                                    break;
                                default:
    ...
    <div class="compare_wrap">
        ...
        <section id="anc_sodr_orderer" class="compare_left">
            ...
            <div class="tbl_frm01">
                ...
                <tbody>
                <tr>
                    <th scope="row"><label for="select_date"><span class="sound_only">주문하신 분 </span>선택일자</label></th>
                    <td><input type="text" name="select_date" value="<?php echo get_text($od['select_date']); ?>" id="select_date" readonly class="frm_input readonly"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th scope="row"><label for="od_addr2"><span class="sound_only">주문하신 분 </span>FIRST NAME</label></th>
                    <td><input type="text" name="od_addr2" value="<?php echo get_text($od['od_addr2']); ?>" id="od_addr2" class="frm_input"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_addr3"><span class="sound_only">주문하신 분 </span>LAST NAME</label></th>
                    <td><input type="text" name="od_addr3" value="<?php echo get_text($od['od_addr3']); ?>" id="od_addr3" class="frm_input"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_addr1"><span class="sound_only">주문하신 분 </span>Country</label></th>
                    <td><input type="text" name="od_addr1" value="<?php echo get_text($od['od_addr1']); ?>" id="od_addr1" class="frm_input"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="r_addr"><span class="sound_only">주문하신 </span>Address</label></th>
                    <td><input type="text" name="r_addr" value="<?php echo get_text($od['r_addr']); ?>" id="r_addr" class="frm_input"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_tel"><span class="sound_only">주문하신 분 </span>Phone number</label></th>
        ...
        <section id="anc_sodr_taker" class="compare_right">
            ...
            <div class="tbl_frm01">
                <table>
                <caption>Traveler information</caption>
                <colgroup>
                    <col class="grid_4">
                    <col>
                </colgroup>
                <tbody>
                <tr>
                    <th scope="row"><label for="od_b_addr2"><span class="sound_only">Traveler </span>Passport FIRST NAME</label></th>
                    <td><input type="text" name="od_b_addr2" value="<?php echo get_text($od['od_b_addr2']); ?>" id="od_b_addr2" class="frm_input"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_b_addr3"><span class="sound_only">Traveler </span>PassportLAST NAME</label></th>
                    <td><input type="text" name="od_b_addr3" value="<?php echo get_text($od['od_b_addr3']); ?>" id="od_b_addr3" class="frm_input"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_b_addr1"><span class="sound_only">Traveler </span>Country</label></th>
                    <td><input type="text" name="od_b_addr1" value="<?php echo get_text($od['od_b_addr1']); ?>" id="od_b_addr1" class="frm_input"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="r_b_addr"><span class="sound_only">Traveler </span>Address</label></th>
                    <td><input type="text" name="r_b_addr" value="<?php echo get_text($od['r_b_addr']); ?>" id="r_b_addr" class="frm_input"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_addr_jibeon"><span class="sound_only">Traveler </span>Gender</label></th>
                    <td><input type="text" name="od_addr_jibeon" value="<?php echo get_text($od['od_addr_jibeon']); ?>" id="od_addr_jibeon" class="frm_input"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_b_tel"><span class="sound_only">Traveler </span>Phone number</label></th>
                    <td><input type="text" name="od_b_tel" value="<?php echo get_text($od['od_b_tel']); ?>" id="od_b_tel" required class="frm_input required"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_b_addr_jibeon"><span class="sound_only">Traveler </span>E-mail</label></th>
                    <td><input type="text" name="od_b_addr_jibeon" value="<?php echo $od['od_b_addr_jibeon']; ?>" id="od_b_addr_jibeon" required class="frm_input email required" size="30"></td>
                </tr>
                <tr>
                    <th scope="row"><label for="od_memo"><span class="sound_only">Traveler </span>Memo</label></th>
                    <td><input type="text" name="od_memo" value="<?php echo $od['od_memo']; ?>" id="od_memo" required class="frm_input email required" size="30"></td>
                </tr>
                </tbody>
                </table>
            </div>
