...
if (!function_exists("itemdelete")) {
    ...
    function itemdelete($it_id)
    {
        ...
        $sql = " select it_explan, it_explan3, it_mobile_explan, it_img1, it_img2, it_img3, it_img4, it_img5, it_img6, it_img7, it_img8, it_img9, it_img10
        ...
        $imgs = get_editor_image($it['it_explan3'], false);
