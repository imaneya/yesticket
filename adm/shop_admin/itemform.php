...
<section id="anc_sitfrm_cate">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
        <tr>
          <th scope="row"><label for="it_cn">언어분류</label></th>
          <td>
              <?php if ($w == "") echo help("기본분류를 선택하면, 판매/재고/HTML사용/판매자 E-mail 등을, 선택한 분류의 기본값으로 설정합니다."); ?>
              <select name="it_cn" id="it_cn" style="width:115px;">
                <option value="0" <?php echo get_selected($it['it_cn'], '0'); ?>>영문</option>
                <option value="1" <?php echo get_selected($it['it_cn'], '1'); ?>>중문</option>
              </select>
          </td>
        </tr>
        <tr>
...
<section id="anc_sitfrm_skin" class="none">
...
<!--                <input type="checkbox" name="it_type3" value="1" <?php echo ($it['it_type3'] ? "checked" : ""); ?> id="it_type3">
        ...
        <tr>
            <th scope="row"><label for="it_maker">시작일</label></th>
            <td>
                ...
                $(function() {
                    $("#it_maker").datepicker({
                        ...
                        $("#it_origin").datepicker( "option", "minDate", selectedDate );
                        }
                    });
                });
                </script>
...
<section id="anc_sitfrm_compact" class="none">
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                USD <input type="text" name="it_price" value="<?php echo $it['it_price']; ?>" id="it_price" class="frm_input" size="8">
            </td>
            <td class="td_grpset">
...
<section id="anc_sitfrm_sendcost" class="none">
...
<section id="anc_sitfrm_img">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php for($i=1; $i<=10; $i++) { ?>
        <tr>
            <th scope="row"><label for="it_img<?php echo $i; ?>"><?php if($i==1) echo "리스트"; else echo "상세" ?> 이미지 <?php if($i!=1) echo $i-1; ?></label></th>
            <td>
...
<section id="anc_sitfrm_relation" class="srel none">
...
<section id="anc_sitfrm_event" class="srel none">
...
<section id="anc_sitfrm_optional" class="none">
...
<section id="anc_sitfrm_extra" class="none">
    <h2>여분필드 설정</h2>
    <?php echo $pg_anchor ?>
...
function fitemformcheck(f)
{
    ...
    <?php echo get_editor_js('it_explan3'); ?>
