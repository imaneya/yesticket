...
$qstr1 = "od_addr=".$od_addr."&amp;od_status=".urlencode($od_status)."&amp;od_settle_case=".urlencode($od_settle_case)."&amp;od_misu=$od_misu&amp;od_cancel_price=$od_cancel_price&amp;od_refund_price=$od_refund_price&amp;od_receipt_point=$od_receipt_point&amp;od_coupon=$od_coupon&amp;fr_date=$fr_date&amp;to_date=$to_date&amp;sel_field=$sel_field&amp;&amp;search=$search&amp;save_search=$search";
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="orderlist<?php echo ' '.$bg; ?>">
        ...
        <td rowspan="3" class="td_addr"><?php echo $row['od_addr1']; ?></td>
